...
EXTERN_C const IID IID_ICredentialProviderCredentialEvents;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE SetFieldState( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ CREDENTIAL_PROVIDER_FIELD_STATE cpfs) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldInteractiveState( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ CREDENTIAL_PROVIDER_FIELD_INTERACTIVE_STATE cpfis) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldString( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [unique][string][in] */ LPCWSTR psz) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldCheckbox( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ BOOL bChecked,
            /* [in] */ LPCWSTR pszLabel) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldBitmap( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ HBITMAP hbmp) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldComboBoxSelectedItem( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwSelectedItem) = 0;
        
        virtual int STDMETHODCALLTYPE DeleteFieldComboBoxItem( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwItem) = 0;
        
        virtual int STDMETHODCALLTYPE AppendFieldComboBoxItem( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [string][in] */ LPCWSTR pszItem) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldSubmitButton( 
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwAdjacentTo) = 0;
        
        virtual int STDMETHODCALLTYPE OnCreatingWindow( 
    ...
    typedef struct ICredentialProviderCredentialEventsVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *SetFieldState )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ CREDENTIAL_PROVIDER_FIELD_STATE cpfs);
        
        int ( STDMETHODCALLTYPE *SetFieldInteractiveState )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ CREDENTIAL_PROVIDER_FIELD_INTERACTIVE_STATE cpfis);
        
        int ( STDMETHODCALLTYPE *SetFieldString )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [unique][string][in] */ LPCWSTR psz);
        
        int ( STDMETHODCALLTYPE *SetFieldCheckbox )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ BOOL bChecked,
        ...
        int ( STDMETHODCALLTYPE *SetFieldBitmap )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ HBITMAP hbmp);
        
        int ( STDMETHODCALLTYPE *SetFieldComboBoxSelectedItem )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwSelectedItem);
        
        int ( STDMETHODCALLTYPE *DeleteFieldComboBoxItem )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwItem);
        
        int ( STDMETHODCALLTYPE *AppendFieldComboBoxItem )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [string][in] */ LPCWSTR pszItem);
        
        int ( STDMETHODCALLTYPE *SetFieldSubmitButton )( 
            ICredentialProviderCredentialEvents * This,
            /* [in] */ ICredentialProviderCredential *pcpc,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwAdjacentTo);
        
        int ( STDMETHODCALLTYPE *OnCreatingWindow )( 
            ICredentialProviderCredentialEvents * This,
            /* [out] */ HWND *phwndOwner);
...
EXTERN_C const IID IID_ICredentialProviderCredential;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE Advise( 
            /* [annotation][in] */ 
            _In_  ICredentialProviderCredentialEvents *pcpce) = 0;
        
        virtual int STDMETHODCALLTYPE UnAdvise( void) = 0;
        
        virtual int STDMETHODCALLTYPE SetSelected( 
            /* [annotation][out] */ 
            _Out_  BOOL *pbAutoLogon) = 0;
        
        virtual int STDMETHODCALLTYPE SetDeselected( void) = 0;
        
        virtual int STDMETHODCALLTYPE GetFieldState( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE GetStringValue( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][string][out] */ 
            _Outptr_result_nullonfailure_  LPWSTR *ppsz) = 0;
        
        virtual int STDMETHODCALLTYPE GetBitmapValue( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Outptr_result_nullonfailure_  HANDLE *phbmp) = 0;
        
        virtual int STDMETHODCALLTYPE GetCheckboxValue( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE GetSubmitButtonValue( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  DWORD *pdwAdjacentTo) = 0;
        
        virtual int STDMETHODCALLTYPE GetComboBoxValueCount( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  DWORD *pcItems,
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE GetComboBoxValueAt( 
            /* [in] */ DWORD dwFieldID,
            DWORD dwItem,
            /* [annotation][string][out] */ 
            _Outptr_result_nullonfailure_  LPWSTR *ppszItem) = 0;
        
        virtual int STDMETHODCALLTYPE SetStringValue( 
            /* [in] */ DWORD dwFieldID,
            /* [annotation][string][in] */ 
            _In_  LPCWSTR psz) = 0;
        
        virtual int STDMETHODCALLTYPE SetCheckboxValue( 
            /* [in] */ DWORD dwFieldID,
            /* [in] */ BOOL bChecked) = 0;
        
        virtual int STDMETHODCALLTYPE SetComboBoxSelectedValue( 
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwSelectedItem) = 0;
        
        virtual int STDMETHODCALLTYPE CommandLinkClicked( 
            /* [in] */ DWORD dwFieldID) = 0;
        
        virtual int STDMETHODCALLTYPE GetSerialization( 
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE ReportResult( 
    ...
    typedef struct ICredentialProviderCredentialVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *Advise )( 
            ICredentialProviderCredential * This,
            /* [annotation][in] */ 
            _In_  ICredentialProviderCredentialEvents *pcpce);
        
        int ( STDMETHODCALLTYPE *UnAdvise )( 
            ICredentialProviderCredential * This);
        
        int ( STDMETHODCALLTYPE *SetSelected )( 
            ICredentialProviderCredential * This,
            /* [annotation][out] */ 
            _Out_  BOOL *pbAutoLogon);
        
        int ( STDMETHODCALLTYPE *SetDeselected )( 
            ICredentialProviderCredential * This);
        
        int ( STDMETHODCALLTYPE *GetFieldState )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  CREDENTIAL_PROVIDER_FIELD_STATE *pcpfs,
        ...
        int ( STDMETHODCALLTYPE *GetStringValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][string][out] */ 
            _Outptr_result_nullonfailure_  LPWSTR *ppsz);
        
        int ( STDMETHODCALLTYPE *GetBitmapValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Outptr_result_nullonfailure_  HANDLE *phbmp);
        
        int ( STDMETHODCALLTYPE *GetCheckboxValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  BOOL *pbChecked,
        ...
        int ( STDMETHODCALLTYPE *GetSubmitButtonValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  DWORD *pdwAdjacentTo);
        
        int ( STDMETHODCALLTYPE *GetComboBoxValueCount )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][out] */ 
            _Out_  DWORD *pcItems,
        ...
        int ( STDMETHODCALLTYPE *GetComboBoxValueAt )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            DWORD dwItem,
            /* [annotation][string][out] */ 
        ...
        int ( STDMETHODCALLTYPE *SetStringValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [annotation][string][in] */ 
            _In_  LPCWSTR psz);
        
        int ( STDMETHODCALLTYPE *SetCheckboxValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ BOOL bChecked);
        
        int ( STDMETHODCALLTYPE *SetComboBoxSelectedValue )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID,
            /* [in] */ DWORD dwSelectedItem);
        
        int ( STDMETHODCALLTYPE *CommandLinkClicked )( 
            ICredentialProviderCredential * This,
            /* [in] */ DWORD dwFieldID);
        
        int ( STDMETHODCALLTYPE *GetSerialization )( 
            ICredentialProviderCredential * This,
            /* [annotation][out] */ 
            _Out_  CREDENTIAL_PROVIDER_GET_SERIALIZATION_RESPONSE *pcpgsr,
            /* [annotation][out] */ 
        ...
        int ( STDMETHODCALLTYPE *ReportResult )( 
            ICredentialProviderCredential * This,
            /* [in] */ NTSTATUS ntsStatus,
            /* [in] */ NTSTATUS ntsSubstatus,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_IQueryContinueWithStatus;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE SetStatusMessage( 
            /* [annotation][string][in] */ 
            _In_  LPCWSTR psz) = 0;
    ...
    typedef struct IQueryContinueWithStatusVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *SetStatusMessage )( 
            IQueryContinueWithStatus * This,
            /* [annotation][string][in] */ 
            _In_  LPCWSTR psz);
...
EXTERN_C const IID IID_IConnectableCredentialProviderCredential;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE Connect( 
            /* [annotation][in] */ 
            _In_  IQueryContinueWithStatus *pqcws) = 0;
        
        virtual int STDMETHODCALLTYPE Disconnect( void) = 0;
    ...
    typedef struct IConnectableCredentialProviderCredentialVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *Connect )( 
            IConnectableCredentialProviderCredential * This,
            /* [annotation][in] */ 
            _In_  IQueryContinueWithStatus *pqcws);
        
        int ( STDMETHODCALLTYPE *Disconnect )( 
            IConnectableCredentialProviderCredential * This);
...
EXTERN_C const IID IID_ICredentialProviderEvents;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE CredentialsChanged( 
    ...
    typedef struct ICredentialProviderEventsVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *CredentialsChanged )( 
            ICredentialProviderEvents * This,
...
EXTERN_C const IID IID_ICredentialProvider;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE SetUsageScenario( 
            /* [in] */ CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus,
            /* [in] */ DWORD dwFlags) = 0;
        
        virtual int STDMETHODCALLTYPE SetSerialization( 
            /* [annotation][in] */ 
        ...
        virtual int STDMETHODCALLTYPE GetFieldDescriptorCount( 
            /* [annotation][out] */ 
            _Out_  DWORD *pdwCount) = 0;
        
        virtual int STDMETHODCALLTYPE GetFieldDescriptorAt( 
            /* [in] */ DWORD dwIndex,
            /* [annotation][out] */ 
            _Outptr_result_nullonfailure_  CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR **ppcpfd) = 0;
        
        virtual int STDMETHODCALLTYPE GetCredentialCount( 
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE GetCredentialAt( 
            /* [in] */ DWORD dwIndex,
            /* [annotation][out] */ 
    ...
    typedef struct ICredentialProviderVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *SetUsageScenario )( 
            ICredentialProvider * This,
            /* [in] */ CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus,
            /* [in] */ DWORD dwFlags);
        
        int ( STDMETHODCALLTYPE *SetSerialization )( 
            ICredentialProvider * This,
            /* [annotation][in] */ 
        ...
        int ( STDMETHODCALLTYPE *GetFieldDescriptorCount )( 
            ICredentialProvider * This,
            /* [annotation][out] */ 
            _Out_  DWORD *pdwCount);
        
        int ( STDMETHODCALLTYPE *GetFieldDescriptorAt )( 
            ICredentialProvider * This,
            /* [in] */ DWORD dwIndex,
            /* [annotation][out] */ 
            _Outptr_result_nullonfailure_  CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR **ppcpfd);
        
        int ( STDMETHODCALLTYPE *GetCredentialCount )( 
            ICredentialProvider * This,
            /* [annotation][out] */ 
            _Out_  DWORD *pdwCount,
            /* [annotation][out] */ 
        ...
        int ( STDMETHODCALLTYPE *GetCredentialAt )( 
            ICredentialProvider * This,
            /* [in] */ DWORD dwIndex,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderFilter;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE Filter( 
            /* [in] */ CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus,
            /* [in] */ DWORD dwFlags,
        ...
        virtual int STDMETHODCALLTYPE UpdateRemoteCredential( 
            /* [annotation][in] */ 
    ...
    typedef struct ICredentialProviderFilterVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *UpdateRemoteCredential )( 
            ICredentialProviderFilter * This,
            /* [annotation][in] */ 
            _In_  const CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION *pcpcsIn,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderCredential2;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE GetUserSid( 
            /* [annotation][string][out] */ 
    ...
    typedef struct ICredentialProviderCredential2Vtbl
    {
        ...
        int ( STDMETHODCALLTYPE *GetUserSid )( 
            ICredentialProviderCredential2 * This,
            /* [annotation][string][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderCredentialWithFieldOptions;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE GetFieldOptions( 
            /* [in] */ DWORD fieldID,
            /* [annotation][out] */ 
    ...
    typedef struct ICredentialProviderCredentialWithFieldOptionsVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *GetFieldOptions )( 
            ICredentialProviderCredentialWithFieldOptions * This,
            /* [in] */ DWORD fieldID,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderCredentialEvents2;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE BeginFieldUpdates( void) = 0;
        
        virtual int STDMETHODCALLTYPE EndFieldUpdates( void) = 0;
        
        virtual int STDMETHODCALLTYPE SetFieldOptions( 
    ...
    typedef struct ICredentialProviderCredentialEvents2Vtbl
    {
        ...
        int ( STDMETHODCALLTYPE *BeginFieldUpdates )( 
            ICredentialProviderCredentialEvents2 * This);
        
        int ( STDMETHODCALLTYPE *EndFieldUpdates )( 
            ICredentialProviderCredentialEvents2 * This);
        
        int ( STDMETHODCALLTYPE *SetFieldOptions )( 
            ICredentialProviderCredentialEvents2 * This,
            /* [in] */ ICredentialProviderCredential *credential,
            /* [in] */ DWORD fieldID,
...
EXTERN_C const IID IID_ICredentialProviderUser;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE GetSid( 
            /* [annotation][string][out] */ 
            _Outptr_result_nullonfailure_  LPWSTR *sid) = 0;
        
        virtual int STDMETHODCALLTYPE GetProviderID( 
            /* [annotation][out] */ 
        ...
        virtual int STDMETHODCALLTYPE GetValue( 
            /* [annotation][in] */ 
            _In_  REFPROPERTYKEY key,
            /* [annotation][out] */ 
    ...
    typedef struct ICredentialProviderUserVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *GetSid )( 
            ICredentialProviderUser * This,
            /* [annotation][string][out] */ 
            _Outptr_result_nullonfailure_  LPWSTR *sid);
        
        int ( STDMETHODCALLTYPE *GetProviderID )( 
            ICredentialProviderUser * This,
            /* [annotation][out] */ 
        ...
        int ( STDMETHODCALLTYPE *GetValue )( 
            ICredentialProviderUser * This,
            /* [annotation][in] */ 
            _In_  REFPROPERTYKEY key,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderUserArray;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE SetProviderFilter( 
            /* [in] */ REFGUID guidProviderToFilterTo) = 0;
        
        virtual int STDMETHODCALLTYPE GetAccountOptions( 
            /* [annotation][out] */ 
            _Out_  CREDENTIAL_PROVIDER_ACCOUNT_OPTIONS *credentialProviderAccountOptions) = 0;
        
        virtual int STDMETHODCALLTYPE GetCount( 
            /* [annotation][out] */ 
            _Out_  DWORD *userCount) = 0;
        
        virtual int STDMETHODCALLTYPE GetAt( 
            /* [in] */ DWORD userIndex,
            /* [annotation][out] */ 
    ...
    typedef struct ICredentialProviderUserArrayVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *SetProviderFilter )( 
            ICredentialProviderUserArray * This,
            /* [in] */ REFGUID guidProviderToFilterTo);
        
        int ( STDMETHODCALLTYPE *GetAccountOptions )( 
            ICredentialProviderUserArray * This,
            /* [annotation][out] */ 
            _Out_  CREDENTIAL_PROVIDER_ACCOUNT_OPTIONS *credentialProviderAccountOptions);
        
        int ( STDMETHODCALLTYPE *GetCount )( 
            ICredentialProviderUserArray * This,
            /* [annotation][out] */ 
            _Out_  DWORD *userCount);
        
        int ( STDMETHODCALLTYPE *GetAt )( 
            ICredentialProviderUserArray * This,
            /* [in] */ DWORD userIndex,
            /* [annotation][out] */ 
...
EXTERN_C const IID IID_ICredentialProviderSetUserArray;
    ...
    {
    public:
        virtual int STDMETHODCALLTYPE SetUserArray( 
            /* [annotation][in] */ 
    ...
    typedef struct ICredentialProviderSetUserArrayVtbl
    {
        ...
        int ( STDMETHODCALLTYPE *SetUserArray )( 
            ICredentialProviderSetUserArray * This,
            /* [annotation][in] */ 
